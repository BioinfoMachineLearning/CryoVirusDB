...
for i in range(len(empiar_ids)):
    ...
    try:
        ...
        try:
            data_download_path = f'/home/ad256/Ashwin/Projects/CryoVirusDB/repo/data_downloads/{empiar_id}/data'
        ...
        try:
            gain_download_path = f'/home/ad256/Ashwin/Projects/CryoVirusDB/repo/data_downloads/{empiar_id}/gain'
